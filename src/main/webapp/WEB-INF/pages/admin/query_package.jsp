	...
	<body>
		...
		<div class="container-fluid" style="padding-left: 0px;">
			<div class="well">
				...
				<form action="${pageContext.request.contextPath}/admin/queryPkgByPrmt" method="post">
        ...
        <c:forEach items="${list}" var="vo">
					<tr>
						...
						<td>${vo.nowPlace}</td>
						<td>
							<a href="${pageContext.request.contextPath}/admin/pkgInfo?exp_id=${vo.pkg.exp_id}">详情</a>
						</td>
					</tr>
				</c:forEach>
				</tbody>
